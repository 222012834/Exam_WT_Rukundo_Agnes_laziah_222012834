...
<center>
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold; color:blue;">THIS TABLE SHOWS QUIZ IN THIS PLATFORM </h4>
        <a href="quiz.html" class="btn btn-primary" style="margin-top: 0px;">quiz</a>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='updatequiz.php?QuizID={$row['QuizID']}' class='btn btn-primary btn-sm'>Update</a></td>
                            <td>
                            <a href='deletequiz.php?QuizID={$row['QuizID']}' class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
