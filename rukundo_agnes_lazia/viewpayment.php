...
<center>
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold; color:blue;">THIS TABLE SHOWS PAYMENTS IN THIS PLATFORM </h4>
        <a href="payment.html" class="btn btn-primary" style="margin-top: 0px;">payments</a>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='updatepayment.php?PaymentID={$row['PaymentID']}' class='btn btn-primary btn-sm'>Update</a></td>
                            <td>
                            <a href='deletepayment.php?PaymentID={$row['PaymentID']}' class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
