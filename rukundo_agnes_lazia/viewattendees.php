...
<center>
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold; color:blue;">THIS TABLE SHOWS ATTENDEES IN THIS PLATFORM </h4>
        <a href="attendees.html" class="btn btn-primary" style="margin-top: 0px;">attendence</a>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='updateattendees.php?AttendeeID={$row['AttendeeID']}' class='btn btn-primary btn-sm'>Update</a></td>
                            <td>
                            <a href='deleteattendees.php?AttendeeID={$row['AttendeeID']}' class='btn btn-danger btn-sm'>Delete</a>
                        </td>
                    </tr>
                    ";
                }
